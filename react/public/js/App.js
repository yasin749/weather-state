...
var _weatherBoxList = __webpack_require__(/*! ./js/components/weather-box-list */ "./resources/assets/js/components/weather-box-list.js");

var _weatherBoxList2 = _interopRequireDefault(_weatherBoxList);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Index = function Index() {
    return _react2.default.createElement(_weatherBoxList2.default, null);
};
...
var config = {
    weatherState: {
        api: {
            ...
            dataUrl: '//api.openweathermap.org/data/2.5/',
...
/***/ "./resources/assets/js/components/weather-box-list.js":
/*!************************************************************!*\
  !*** ./resources/assets/js/components/weather-box-list.js ***!
  \************************************************************/
/*! no static exports found */
...
var _config = __webpack_require__(/*! ../../config */ "./resources/assets/config.js");

var _config2 = _interopRequireDefault(_config);

var _weatherBox = __webpack_require__(/*! ./weather-box */ "./resources/assets/js/components/weather-box.js");

var _weatherBox2 = _interopRequireDefault(_weatherBox);

var _dateTimeFormat = __webpack_require__(/*! ../helpers/date-time-format */ "./resources/assets/js/helpers/date-time-format.js");
...
var WeatherBoxList = function (_React$Component) {
    _inherits(WeatherBoxList, _React$Component);

    function WeatherBoxList(props) {
        _classCallCheck(this, WeatherBoxList);

        var _this = _possibleConstructorReturn(this, (WeatherBoxList.__proto__ || Object.getPrototypeOf(WeatherBoxList)).call(this, props));

        _this.state = {
            error: null,
            isLoaded: false,
            cities: [],
            nowDate: _this.nowDateString(new Date())
        };
        return _this;
    }

    _createClass(WeatherBoxList, [{
        ...
        value: function loadCities() {
            var cities = _config2.default.weatherState.cities;

            for (var city in _config2.default.weatherState.cities) {
                var cityId = cities[city].id;
                var apiUrl = this.apiUrlPrepared(cityId);
        ...
        key: 'apiUrlPrepared',
        value: function apiUrlPrepared(cityId) {
            var apiUrl = _config2.default.weatherState.api.dataUrl + 'weather?id=' + cityId + '&appid=' + _config2.default.weatherState.api.appId + '&units=metric';
            return apiUrl;
        }
    }, {
        key: 'apiFetchData',
        value: function apiFetchData(url) {
            var _this2 = this;
            ...
            fetch(url).then(function (res) {
                ...
                _this2.setState({
                    isLoaded: true,
                    cities: _this2.state.cities.concat([result])
                });
            }, function (error) {
                _this2.setState({
                    isLoaded: true,
        ...
        key: 'nowDateString',
        value: function nowDateString(date) {
            var formattedDate = (0, _dateTimeFormat2.default)(date);
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        cities.map(function (city, key) {
                            return _react2.default.createElement(
                                'div',
                                { className: 'col-4 col-xs-6', key: key },
                                _react2.default.createElement(_weatherBox2.default, { city: city })
                            );
                        })
                    )
                );
...
exports.default = WeatherBoxList;

/***/ }),

/***/ "./resources/assets/js/components/weather-box.js":
/*!*******************************************************!*\
  !*** ./resources/assets/js/components/weather-box.js ***!
  \*******************************************************/
/*! no static exports found */
...
var WeatherBox = function (_React$Component) {
    ...
    function WeatherBox(props) {
        ...
        return _possibleConstructorReturn(this, (WeatherBox.__proto__ || Object.getPrototypeOf(WeatherBox)).call(this, props));
    }

    _createClass(WeatherBox, [{
        key: "imageUrlPrepared",
        value: function imageUrlPrepared() {
            var imageUrl = "" + _config2.default.weatherState.api.iconUrl + this.props.city.weather[0].icon + ".png";
            return imageUrl;
        }
    }, {
        key: "render",
        value: function render() {
            ...
            return _react2.default.createElement(
                "div",
                { className: "box weather-box" },
                _react2.default.createElement(
                    "span",
                    { className: "city-name" },
                    city.name
                ),
                _react2.default.createElement("img", { src: this.imageUrlPrepared(), className: "ico", alt: city.name }),
                _react2.default.createElement(
                    "span",
                ...
                _react2.default.createElement(
                    "span",
                    { className: "button small border-button" },
                    "Five day forecast"
                )
            );
        }
...
/***/ "./resources/assets/js/helpers/date-time-format.js":
/*!*********************************************************!*\
  !*** ./resources/assets/js/helpers/date-time-format.js ***!
  \*********************************************************/
/*! no static exports found */
...
module.exports = __webpack_require__(/*! ./resources/assets/App.js */"./resources/assets/App.js");
