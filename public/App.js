...
var _weatherBoxList = __webpack_require__(9);
...
var _dateTimeFormat = __webpack_require__(4);

var _dateTimeFormat2 = _interopRequireDefault(_dateTimeFormat);

var _weatherBox = __webpack_require__(11);
...
var weatherBoxList = _vue2.default.component('weather-box-list', {
    data: function data() {
        return {
            cities: [],
    ...
    methods: {
        ...
        apiUrlPrepared: function apiUrlPrepared(cityId) {
        ...
        apiFetchData: function apiFetchData(url) {
            var _this = this;

            this.$http.get(url).then(function (response) {
                _this.cities.push(response.body);
            }, function (response) {
                console.log('Api verileri alınamadı');
            });
        },
        nowDateString: function nowDateString(date) {
...
var _weatherLineList = __webpack_require__(13);

var _weatherLineList2 = _interopRequireDefault(_weatherLineList);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var weatherBox = _vue2.default.component('weather-box', {
    props: {
...
var popup = _vue2.default.component('popup', {
    data: function data() {
        return {};
    },
    methods: {
...
var _weatherLine = __webpack_require__(14);

var _weatherLine2 = _interopRequireDefault(_weatherLine);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_vue2.default.use(_vueResource2.default);

var weatherLineList = _vue2.default.component('weather-line-list', {
    props: {
    ...
    methods: {
        loadForecasts: function loadForecasts() {
            var apiUrl = this.apiUrlPrepared(this.cityId);
            this.apiFetchData(apiUrl);
        },
        apiUrlPrepared: function apiUrlPrepared(cityId) {
            var apiUrl = _config2.default.weatherState.api.dataUrl + 'forecast?id=' + cityId + '&appid=' + _config2.default.weatherState.api.appId + '&units=metric';
            return apiUrl;
        },
        apiFetchData: function apiFetchData(url) {
            var _this = this;
...
var weatherLine = _vue2.default.component('weather-line', {
    props: {
        forecast: { type: Object, required: true }
    },
    data: function data() {
        return {
            date: (0, _dateTimeFormat2.default)(new Date(this.forecast.dt_txt))
        };
    },
    methods: {
        imageUrlPrepared: function imageUrlPrepared() {
            var imageUrl = '' + _config2.default.weatherState.api.iconUrl + this.forecast.weather[0].icon + '.png';
            return imageUrl;
        }
